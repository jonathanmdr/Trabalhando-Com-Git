...
(Ex.: Windows: C:\Users\Documents and Settings\Jonathan ou *nix /home/jonathan).

As configurações realizadas através dos comandos abaixo serão incluídas no arquivo citado acima.

##### Setar usuário
	git config --global user.name "Jonathan Henrique"

##### Setar email
	git config --global user.email jonathan.mdr@hotmail.com
...
### Vincular repositório local com um repositório remoto
	...
	git remote add origin https://github.com/jonathanmdr/Trabalhando-Com-Git.git
...
### Clonar um repositório remoto já existente
	...
	git clone https://github.com/jonathanmdr/Trabalhando-Com-Git.git
...
* O merge automático será feito em arquivos textos que não sofreram alterações nas mesmas linhas. 
* O merge manual será feito em arquivos textos que sofreram alterações nas mesmas linhas.
...
Autor Principal: [@Leonardo Comelli](https://gist.github.com/leocomelli)
